        ...
        <template #tableSection>
          <div class="h-full">
            <el-table :data="[]" style="width: 100%">
              <el-table-column prop="name" label="Payment Reference" />
              <el-table-column prop="email" label="Description" />
              <el-table-column prop="role" label="Customer name" />
              <el-table-column prop="role" label="Source" />
              <el-table-column prop="role" label="Amount" />
              <el-table-column prop="role" label="Date and Time Created" />
